...
单个 issue 的任务定义在 `go/WORKFLOW.zh-smoke.md`；本 skill 只编排实验循环。
...
- Workflow：`go/WORKFLOW.zh-smoke.md`
- 外层 round 脚本：`go/scripts/zh_smoke_round.py`
- 指标脚本：`go/scripts/smoke_metrics.py`
...
- 缩短 `go/WORKFLOW.zh-smoke.md` 的说明文本。
